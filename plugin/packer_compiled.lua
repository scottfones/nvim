...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lsp-signature-help"] = {
    loaded = true,
    path = "/home/scott/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp-signature-help",
  ...
  ["lsp_signature.nvim"] = {
    loaded = true,
    path = "/home/scott/.local/share/nvim/site/pack/packer/start/lsp_signature.nvim",
  ...
  ["rust.vim"] = {
    loaded = true,
    path = "/home/scott/.local/share/nvim/site/pack/packer/start/rust.vim",
  ...
  ["vim-gitgutter"] = {
    loaded = true,
    path = "/home/scott/.local/share/nvim/site/pack/packer/start/vim-gitgutter",
